...
public class CheckoutController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<ActionResult> CheckoutOrder([FromBody] Order product, [FromServices] IServiceProvider sp)
    {
        //var referer = Request.Headers.Referer;
        //s_wasmClientURL = referer[0];
        s_wasmClientURL = "https://localhost:23235/";
    ...
    [NonAction]
    public async Task<string> CheckOut(Order product, string thisApiUrl)
    {
